document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    const percentProgress =
      ((quiz.currentQuestionIndex + 1) / totalQuestion) * 100;
    progressBar.style.width = `${percentProgress}%`; // This value is hardcoded as a placeholder
    ...
    } of ${totalQuestion}`; //  This value is hardcoded as a placeholder
    ...
    for (let i = 0; i < question.choices.length; i++) {
      const inputChoices = question.choices[i];
